...
{{--    <div class="h-full px-3 py-4 overflow-y-auto bg-gradient-to-l bg-gray-100 border-1 border-black">--}}

{{--        <ul class="space-y-2 font-medium">--}}
{{--            <li>--}}
{{--                <a href="" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-grey hover:bg-gray-100 dark:hover:bg-gray-700">--}}
{{--                    <svg aria-hidden="true" class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg>--}}
{{--                    <span class="ml-3">Dashboard</span>--}}
{{--                </a>--}}
{{--            </li>--}}
{{--            <li>--}}
{{--                <a href="/calendar" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-grey hover:bg-gray-100 dark:hover:bg-gray-700">--}}
...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transform -translate-x-full sm:translate-x-0 transition-transform ease-in-out duration-300 bg-white border-r-2 border-pink-200">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-100">
        <ul class="space-y-2 font-medium">
            <li>
                <a href="/" class="">
                    <img class="w-48  " src="{{asset('images/mylogo.png')}}" alt="Logo" />
                </a>
            </li><li>
