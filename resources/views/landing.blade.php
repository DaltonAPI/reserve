...
<head>
    ...
    <title>Small Business Reservation App</title>
    <style>
...
<body>
<!-- Hero Section -->
<section class="hero bg-cover bg-center py-20 bg-pink-400">
    <div class="container mx-auto text-center">
        ...
        <a href="/landing" class="bg-pink-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">Get Started</a>
    </div>
</section>
    ...
    <div class="container mx-auto">
        <div class="flex flex-col md:flex-row items-center justify-center">
            <div class="md:w-1/2">
                ...
                <a href="#" class="bg-pink-500 hover:bg-pink-600 text-white font-bold py-2 px-4 rounded">Explore Listings</a>
            </div>
    ...
    <div class="container mx-auto">
        <div class="flex flex-col md:flex-row items-center justify-center">
            ...
            <div class="md:w-1/2 md:ml-8">
                ...
                <a href="#" class="bg-pink-500 hover:bg-pink-600 text-white font-bold py-2 px-4 rounded">Start Searching</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto">
        <div class="flex flex-col md:flex-row items-center justify-center">
            <div class="md:w-1/2">
                ...
                <a href="#" class="bg-pink-500 hover:bg-pink-600 text-white font-bold py-2 px-4 rounded">View Profiles</a>
            </div>
            <div class="md:w-1/2">
    ...
    <div class="container mx-auto">
        <div class="flex flex-col md:flex-row items-center justify-center">
            ...
            <div class="md:w-1/2 md:ml-8">
                ...
                <a href="#" class="bg-pink-500 hover:bg-pink-600 text-white font-bold py-2 px-4 rounded">Make a Reservation</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto">
        <div class="flex flex-col md:flex-row items-center justify-center">
            <div class="md:w-1/2">
                ...
                <a href="#" class="bg-pink-500 hover:bg-pink-600 text-white font-bold py-2 px-4 rounded">Write a Review</a>
            </div>
            <div class="md:w-1/2">
    ...
    <div class="container mx-auto">
        <div class="flex flex-col md:flex-row items-center justify-center">
            ...
            <div class="md:w-1/2 md:ml-8">
                ...
                <a href="#" class="bg-pink-500 hover:bg-pink-600 text-white font-bold py-2 px-4 rounded">Manage Reservations</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto">
        <div class="flex flex-col md:flex-row items-center justify-center">
            <div class="md:w-1/2">
                ...
                <a href="#" class="bg-pink-500 hover:bg-pink-600 text-white font-bold py-2 px-4 rounded">Make a Payment</a>
            </div>
            <div class="md:w-1/2">
...
<footer class="bg-pink-500 text-white py-6">
    <div class="container mx-auto text-center">
        <p>&copy; 2023 Reservify. All rights reserved.</p>
    </div>
</footer>
