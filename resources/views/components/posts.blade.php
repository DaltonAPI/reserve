...
<div class="rounded-lg shadow-md overflow-hidden">
    <a href="#" class="block">
        <div class="relative">
            <img src="{{ asset('storage/' . $post->thumbnail) }}" alt="Post Thumbnail" class="w-full h-48 object-cover rounded-t-lg">
        ...
        <div class="p-2">
            <h3 class="text-lg font-bold text-gray-900"><a href="/posts/{{$post->id}}">{{$post->title}}</a></h3>
            ...
            <div class="flex items-center mt-1">
                ...
                <p class="text-gray-600 ml-2">{{$post->author->name}} @ {{$post->created_at}}</p>
            </div>
